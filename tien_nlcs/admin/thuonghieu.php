                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <a href="add_brand.php" class="btn btn-primary">Thêm thương hiệu sản phẩm</a>
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            while($rows=$result->fetch_assoc()){
                                                ...
                                                echo "  <td>$count</td>
                                                        <td>".$rows['tenhsx']."</td>
                                                        <td><a href='edit_brands.php?idth=".$rows['mahsx']."' id='nut_edit'><i class='fas fa-pencil-alt'></i>Edit</a>
                                                            <a href='del_brands.php?idth=".$rows['mahsx']."' id='nut_del'><i class='fas fa-minus-circle'></i>Delete</a></td>";
                                                echo "</tr>";
                                                $count++;
                                            }
                                         ?>
