                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="xu_ly_add_brand.php" method="POST" enctype="multipart/form-data">
                               <div class="row">
               						<div class="col-sm-6"><label for='tenhsx'>Tên thương hiệu</label></div>
                                    <div class="col-sm-6"><input type="text" id="tenhsx" required name ="name_brand" 
                                          ></div>
