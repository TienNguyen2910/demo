                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="xu_ly_add_product.php" method="POST" enctype="multipart/form-data">
                               <div class="row">
               						<div class="col-sm-6"><label for='tensp'>Tên sản phẩm</label></div>
                                    <div class="col-sm-6"><input type="text" id="tensp" required name ="name_item"
                                          ></div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6"><label for='sl'>Số lượng</label></div>
                                        <div class="col-sm-6"><input type="text"  id="sl" required name ="quantity"
                                          > </div>
                                </div>
                                <div class="row">
